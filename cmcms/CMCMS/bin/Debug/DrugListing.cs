...
namespace CMCMS {
    ...
    public class DrugListing : ReportClass {
    ...
    public class CachedDrugListing : Component, ICachedReport {
        
        public CachedDrugListing() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DrugListing rpt = new DrugListing();
            rpt.Site = this.Site;
            return rpt;
        }
