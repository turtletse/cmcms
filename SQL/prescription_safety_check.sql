...
BEGIN
    ...
    SELECT incompatible_drug+g6pd_not_recommended+g6pd_forbidden+pregnant_not_recommended+pregnant_forbidden+drug_wo_dosage+drug_below_min_dosage+drug_exceed_max_dosage INTO safety_violation_cnt
